    ...
    return (
            <div className="card" style={{ width: "20rem",border:'1px solid black'}}>
              <div
                ...
                style={{
                  height: "250px",
                  backgroundImage:`url(http://localhost:4000/public/uploadImages/${props.item.image})`,
              ...
              <div className="card-body" style={{borderTop:'1px solid black'}}>
                ...
                {   props.currUser===props.item.owner?(
                        <div className="btn btn-outline-secondary" onClick={()=> props.deleteItem(props.item._id,props.item.image)}>
                            Cancel Bid
                        </div>
                        ...
                        <div className="btn btn-outline-secondary" onClick={()=> props.bidItem(props.item.curPrice,props.item._id)}>
                             Bid
                        </div>
                    ))
